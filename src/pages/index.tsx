    ...
    <Layout>
      <Container>
        <div className="flex flex-wrap">
          <div className="w-full justify-center items-center sm:w-full md:w-full lg:w-1/2 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1">
            <TurkeyMap onCityClick={handleSearchSubmit} />
          </div>
          <div className="grid grid-cols-1 item-center w-full sm:full md:w-full lg:w-1/2 md:grid-cols-1 lg:grid-cols-1 justify-center items-center">
            {data && (
              data.map((item) => (
